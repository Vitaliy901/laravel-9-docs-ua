...
- #### Пакети
  ...
  - [x] [_Cashier (Stripe)_](https://github.com/laravel/cashier-stripe) – система оплати яка працює зі службою (Stripe). Вона надає виразний, гнучкий інтерфейс для послуги виставлення рахунків за підписку [Stripe's](https://stripe.com/). Також опрацьовує майже весь стандартний платіжний код передплати, який вам страшно писати. На додаток до базового керування підписок, Cashier може керувати купонами, обмінювати підписки, «вартість» підписок, пільгові періоди скасування та навіть створювати PDF-файли рахунків.
