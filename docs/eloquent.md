...
Глобальні області дозволяють додавати обмеження до всіх запитів для певної моделі. Власна функція [програмного видалення](#soft-deleting) Laravel використовує глобальні області видимості для отримання лише «не видалених» моделей з бази даних. Написання власних глобальних областей може забезпечити зручний і простий спосіб переконатися, що кожен запит для даної моделі отримує певні обмеження.
