...
Крім того, ви можете перерахувати своїх спостерігачів у властивості `$observers` класу `App\Providers\EventServiceProvider` вашого додатка:
