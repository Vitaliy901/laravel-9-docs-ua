...
Але, що ми маємо на увазі під «початковим завантаженням»? Загалом ми маємо на увазі **реєстрацію** речей, включаючи реєстрацію зв’язків контейнерів служб, слухачів подій, посередників і навіть маршрутів. Постачальники служб - це місце зосередження, в якому налаштовується ваш додатка.
