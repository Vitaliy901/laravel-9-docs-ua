...
Наприклад, `UserCollection` спробує з'єднати задані екземпляри користувача з ресурсом `UserResource`. Щоб налаштувати цю поведінку, ви можете змінити властивість `$collects` вашої колекції ресурсів:
