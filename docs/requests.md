...
Клас `UploadedFile` також містить методи для доступу до повного шляху файла та його формат. Метод `extension` спробує вгадати формат файлу з урахуванням його вмісту. Цей формат може відрізнятись від формату, наданого клієнтом:
...
Якщо ви не хочете, щоб ім’я файла генерувалося автоматично, ви можете використати метод `storeAs`, який приймає шлях, ім’я файла та ім’я диска:
