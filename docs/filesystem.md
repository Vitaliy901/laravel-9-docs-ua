...
Далі ви можете зареєструвати драйвер у методі `boot` одного з [постачальників служб](/docs/providers) вашого додатка. Щоб досягти цього, ви повинні використовувати метод `extend` фасада `Storage`:
